            ...
            <div className="SoftContainer">
                <div className="SoftContent">
                    ...
                    <p>▪ Я интересуюсь криптовалютами и блокчейн технологиями.
                        У меня есть опыт разработки смарт контрактов на Solidity. Разрабатывал собственный токен, а
                        также участвовал в web3 хакатоне Forward, где удалось вместе с командой разработать собственное
                        dApp.</p>
                </div>
            </div>
        </div>
