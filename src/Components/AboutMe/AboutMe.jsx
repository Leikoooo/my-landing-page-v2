                ...
                <div className="leftAM">
                    <div className="skills">
                        <div className="titleAM">
                            ...
                            <p>Мои проекты включают в себя разработку веб-приложений, а также создание и поддержку
                                сайтов с использованием HTML, CSS и JavaScript</p>
                        </div>
                        <div className="education">
                            <div className="titleAM">
                                <span>Education</span>
                                <h2>Университет ИТМО</h2>
                                <p>Я второкурсник, учусь на факультете информационных технологий и программирования, где
                                    изучаю различные языки программирования, алгоритмы и структуры данных, а также
                                    основы информационной безопасности</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="rightAM">
                    <div className="experinece">
                        <div className="titleAM">
                            ...
                            <p>Я умею работать с библиотеками Flask и Django, а также с базами данных PostgreSQL и
                                MongoDB. Мои проекты включают в себя разработку веб-приложений, а также создание и
                                поддержку сайтов с использованием HTML, CSS и JavaScript.</p>
                        </div>
                    </div>
                </div>
            </div>
